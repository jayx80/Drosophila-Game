...
theme              - (optional) this level's color scheme, an object
                     with two hex colors:
                       accent    - the main accent color (buttons,
                                   highlighted text, glowing dots,
                                   selected-card border, etc)
                       accentDim - a darker/muted version of accent,
                                   used for "selected but not
                                   hovered" states
                     If a level has no "theme", it falls back to the
                     game's default turquoise color scheme. To pick
                     new colors, any hex color works — try to keep
                     accent bright enough to read clearly against the
                     dark background, and accentDim noticeably darker
                     than accent.
...
const LEVELS = [
  {
    ...
    theme: { accent: "#7CFFCB", accentDim: "#3E7A67" },
...
id: "courtship",
    ...
    theme: { accent: "#FF5D8F", accentDim: "#7A2A44" },
